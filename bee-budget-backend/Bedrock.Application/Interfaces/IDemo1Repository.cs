...
namespace Bedrock.Application.Interfaces
{
    ...
    /// </para>
    /// </summary>
    public interface IDemo1Repository
    {
        /// <summary>
        /// 创建一条新的样例1记录。
        /// </summary>
        ...
        Task<long> CreateAsync(Demo1 entity);
        ...
        Task<int> CreateBatchAsync(IEnumerable<Demo1> entities);
        ...
        Task<int> UpdateAsync(Demo1 entity);
        ...
        Task<int> UpdateBatchAsync(IEnumerable<Demo1> entities);
        ...
        Task<int> DeleteAsync(Demo1 entity);
        ...
        /// </returns>
        Task<(List<Demo1> Data, int TotalCount)> GetPagedAsync(
            int pageNumber,
            int pageSize,
            string? name = null,
            string? status = null,
        ...
        /// </summary>
        /// <param name="ids">样例1 ID 列表。</param>
        /// <returns>返回匹配的实体列表（可能为空）。</returns>
        Task<List<Demo1>> GetByIdsAsync(IEnumerable<long> ids);
        ...
        Task<Demo1?> GetByNameAsync(string name);
