...
namespace Bedrock.Application.Interfaces
{
    ...
    public interface IDemo1Service
    {
        ...
        Task<long> CreateAsync(CreateDemo1Dto createDto, long operatorId);
        ...
        Task<int> CreateBatchAsync(IEnumerable<CreateDemo1Dto> createDtos, long operatorId);
        ...
        Task<long> UpdateAsync(UpdateDemo1Dto updateDto, long operatorId);
        ...
        Task<int> UpdateBatchAsync(IEnumerable<UpdateDemo1Dto> updateDtos, long operatorId);
        ...
        Task<Demo1Dto?> GetAsync(long id);
        ...
        Task<List<Demo1Dto>> GetAllAsync(
            string? name = null, 
            string? status = null,
        ...
        /// <summary>
        /// 分页查询未删除的样例1记录，支持名称模糊搜索、状态和Demo1Id精确搜索。
        /// </summary>
        ...
        Task<PaginationResult<Demo1Dto>> GetPagedAsync(
            int pageNumber,
            int pageSize,
            string? name = null,
            string? status = null,
