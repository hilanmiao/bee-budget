...
namespace Bedrock.Application.Interfaces
{
    ...
    public interface ISysDictCategoryService
    {
        ...
        Task<long> CreateAsync(CreateSysDictCategoryDto createDto, long operatorId);
        ...
        Task<int> CreateBatchAsync(IEnumerable<CreateSysDictCategoryDto> createDtos, long operatorId);
        ...
        Task<long> UpdateAsync(UpdateSysDictCategoryDto updateDto, long operatorId);
        ...
        Task<int> UpdateBatchAsync(IEnumerable<UpdateSysDictCategoryDto> updateDtos, long operatorId);
        ...
        Task<SysDictCategoryDto?> GetAsync(long id);
        ...
        Task<List<SysDictCategoryDto>> GetAllAsync(string? name = null, string? status = null);
        ...
        Task<PaginationResult<SysDictCategoryDto>> GetPagedAsync(
            int pageNumber,
            int pageSize,
            string? name = null,
            string? code = null,
        ...
        /// <returns>返回匹配的 DTO；若未找到或已删除，则返回 null。</returns>
        Task<SysDictCategoryDto?> GetByCodeAsync(string code);
        ...
        /// <returns>返回匹配的 DTO；若未找到或已删除，则返回 null。</returns>
        Task<SysDictCategoryDto?> GetByNameAsync(string name);
