...
namespace Bedrock.Application.Interfaces
{
    ...
    public interface IAppService
    {
        ...
        Task<long> CreateAsync(CreateAppDto createDto, long operatorId);
        ...
        Task<long> UpdateAsync(UpdateAppDto updateDto, long operatorId);
        ...
        Task<List<AppDto>> GetAllAsync(string? name = null);
        ...
        Task<PaginationResult<AppDto>> GetPagedAsync(
            int pageNumber,
            int pageSize,
            string? name = null,
        ...
        /// <summary>
        /// 根据App应用名称获取唯一未删除的App应用详情。
        /// </summary>
        /// <param name="appId">AppId（如“__UNI__9B0E754”），用于精确匹配。</param>
        /// <returns>返回匹配的 DTO；若未找到或已删除，则返回 null。</returns>
        Task<AppDto?> GetByAppIdAsync(string appId);
